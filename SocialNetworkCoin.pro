...
MOC_DIR = build
UI_DIR = build
RESOURCES = SocialNetworkCoin.qrc
...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.SocialNetworkCoin
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to SocialNetworkCoin.qrc under translations/
...
macx:ICON = src/qt/res/icons/SocialNetworkCoin.icns
macx:TARGET = "SocialNetworkCoin"
